...
function xmldb_certificate_upgrade($oldversion=0) {
	...
	if($oldversion < 2012031301){
		// Define filed id to be added to certificate
		$table = new xmldb_table('certificate');


		$field = new xmldb_field('eduhours', XMLDB_TYPE_TEXT, 'small', null, null, null, null, null, 'printhours');
		...
		$field = new xmldb_field('location', XMLDB_TYPE_TEXT, 'small', null, null, null, null, null, 'timemodified');
		...
		$field = new xmldb_field('trainer', XMLDB_TYPE_TEXT, 'small', null, null, null, null, null, 'location');
		...
		$field = new xmldb_field('customdate', XMLDB_TYPE_TEXT, 'small', null, null, null, null, null, 'trainer');
		...
		// certificate savepoint reached
		upgrade_mod_savepoint(true, 2012031301, 'certificate');
	}
	...
	if($oldversion < 2012031302){
		...
		$field = new xmldb_field('autogen', XMLDB_TYPE_INTEGER, '2', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, '1', 'customdate');
		...
		// certificate savepoint reached
		upgrade_mod_savepoint(true, 2012031302, 'certificate');
	}

	if($oldversion < 2012031400){
		$table = new xmldb_table('certificate');
		$field = new xmldb_field('customdate2', XMLDB_TYPE_TEXT, 'small', null, null, null, null, null, 'autogen');
		...
		// certificate savepoint reached
		upgrade_mod_savepoint(true, 2012031400, 'certificate');
	}
