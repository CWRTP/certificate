...
$string['customtext_help'] = 'You can print different course names. By default, this text is placed in the original course name.';
$string['date'] = 'On';
...
$string['printhours'] = 'Program Hours';
